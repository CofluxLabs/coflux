...
def _run(project, module, version, host, concurrency):
    try:
        client = Client(project, module, version, host, concurrency)
...
def cli(project, module, version, host, concurrency, reload):
    args = (project, module, version, host, concurrency)
    if reload:
