...
@click.option('environment_name', '-e', '--environment', required=True, help="Environment name")
...
def cli(project: str, environment_name: str, module_name: str, version: str, host: str, concurrency: int, reload: bool) -> None:
